...
const blobParser = new parseOSM.BlobParser();
const blobDecompressor = new parseOSM.BlobDecompressor();
const primitivesParser = new parseOSM.PrimitivesParser();
